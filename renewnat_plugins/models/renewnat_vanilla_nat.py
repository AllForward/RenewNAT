...
@register_model("renewnat_vanilla_nat")
class NATransformerModel(FairseqNATModel):
    ...
    def forward(
        ...
        target_masks = (
            tgt_tokens.ne(self.pad) & tgt_tokens.ne(self.bos) & tgt_tokens.ne(self.eos)
        )
        ...
        output_tokens = tgt_tokens.masked_fill(
...
@register_model_architecture(
    "renewnat_vanilla_nat", "renewnat_vanilla_nat"
)
...
@register_model_architecture(
    "renewnat_vanilla_nat", "renewnat_vanilla_nat_wmt_en_de"
)
