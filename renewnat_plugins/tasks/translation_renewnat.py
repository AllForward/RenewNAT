...
NOISE_CHOICES = ChoiceEnum(["random_delete", "random_mask", "no_noise", "full_mask", "full_and_random_mask"])
...
@register_task("translation_renewnat", dataclass=TranslationLevenshteinConfig)
